 ...
 * the objects.
 */
public final class ObjectSizeComparator implements Comparator<BootImageMap.Entry> {
  private final Comparator<BootImageMap.Entry> identicalSizeComparator;
  public ObjectSizeComparator(Comparator<BootImageMap.Entry> identicalSizeComparator) {
