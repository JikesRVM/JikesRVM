 ...
 */
public final class NumberOfNonFinalReferencesComparator implements Comparator<BootImageMap.Entry> {
  private final Comparator<BootImageMap.Entry> identicalSizeComparator;
  public NumberOfNonFinalReferencesComparator(Comparator<BootImageMap.Entry> identicalSizeComparator) {
