...
final class GenArch_ppc extends GenArch {
  ...
  public final void emitArchAssemblerDeclarations() {
    if (VM.BuildForOsx) {
      ...
      pln("#define STACKFRAME_NEXT_INSTRUCTION_OFFSET " + VM_StackframeLayoutConstants.STACKFRAME_NEXT_INSTRUCTION_OFFSET);
    } else {
