...
public interface VM_JNIStackframeLayoutConstants extends VM_RegisterConstants,
  ...
  int NATIVE_FRAME_HEADER_SIZE =
      ...
      (VM.BuildForSVR4ABI ? 2 * BYTES_IN_ADDRESS /* fp + lr */ : /* BuildForMachOABI */ 6 *
  ...
  int JNI_ENV_OFFSET = JNI_RVM_NONVOLATILE_OFFSET +
  ...
  int JNI_GLUE_RVM_EXTRA_GPRS_SIZE =
