...
public interface StackframeLayoutConstants {
  ...
  int STACKFRAME_RETURN_ADDRESS_OFFSET = VM.BuildForPower64ELF_ABI || VM.BuildForMachOABI ? 2 * BYTES_IN_STACKSLOT : BYTES_IN_STACKSLOT;
  int STACKFRAME_METHOD_ID_OFFSET = VM.BuildForPower64ELF_ABI || VM.BuildForMachOABI ? BYTES_IN_STACKSLOT : 2 * BYTES_IN_STACKSLOT;
