...
import static org.jikesrvm.opt.OPT_IndexPropagation.*;
...
final class OPT_LoadElimination extends OPT_OptimizationPlanCompositeElement {
  ...
  private static class LoadEliminationPreparation extends OPT_CompilerPhase {
     ...
     */
    private static final Constructor<OPT_CompilerPhase> constructor = getCompilerPhaseConstructor("org.jikesrvm.opt.OPT_LoadElimination$LoadEliminationPreparation", new Class[]{Integer.TYPE});
  ...
  private static class GVNPreparation extends OPT_CompilerPhase {
     ...
     * Constructor for this compiler phase
     */
    private static final Constructor<OPT_CompilerPhase> constructor = getCompilerPhaseConstructor("org.jikesrvm.opt.OPT_LoadElimination$GVNPreparation", new Class[]{Integer.TYPE});
