...
final class OPT_DominatorsPhase extends OPT_CompilerPhase {
   ...
   */
  private static final Constructor<OPT_CompilerPhase> constructor = getCompilerPhaseConstructor("org.jikesrvm.opt.OPT_DominatorsPhase", new Class[]{Boolean.TYPE});
