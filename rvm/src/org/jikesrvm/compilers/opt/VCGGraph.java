...
/**
 * VCGGraph provides the minimum set of routines for printing a graph
 * in VCG format.  The graph nodes and edges should implement VCGNode
 * and VCGEdge interfaces respectively.
 *
 * @see VCG
 * @see VCGNode
 * @see VCGEdge
...
public interface VCGGraph extends VisGraph {
  /**
   ...
   */
  class GraphDesc implements VCGConstants {
    /**
