...
public interface PhysicalRegisterConstants extends RegisterConstants {
  ...
  int FIRST_INT_PARAM = FIRST_VOLATILE_GPR.value() + FIRST_INT;
  int NUMBER_INT_PARAM = LAST_VOLATILE_GPR.value() - FIRST_VOLATILE_GPR.value() + 1;
  int FIRST_DOUBLE_PARAM = FIRST_VOLATILE_FPR.value() + FIRST_DOUBLE;
  ...
  // TODO: fix this.
  int FIRST_INT_RETURN = FIRST_VOLATILE_GPR.value() + FIRST_INT;
  int NUMBER_INT_RETURN = 2;
  int FIRST_DOUBLE_RETURN = FIRST_VOLATILE_FPR.value() + FIRST_DOUBLE;
