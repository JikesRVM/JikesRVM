...
public class SpaceEffGraphNode implements GraphNode, VCGNode {
  ...
  final void appendInEdge(SpaceEffGraphEdge e) {
  ...
  final void appendOutEdge(SpaceEffGraphEdge e) {
  ...
  static final class OutEdgeEnumeration implements GraphEdgeEnumeration<GraphEdge> {
    private SpaceEffGraphEdge _edge;
