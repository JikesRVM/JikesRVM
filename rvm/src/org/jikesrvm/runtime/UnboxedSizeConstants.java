...
public final class UnboxedSizeConstants {
  ...
  public static final int LOG_BITS_IN_ADDRESS = JavaSizeConstants.LOG_BITS_IN_BYTE + LOG_BYTES_IN_ADDRESS;
  ...
  public static final int LOG_BITS_IN_WORD = JavaSizeConstants.LOG_BITS_IN_BYTE + LOG_BYTES_IN_WORD;
  ...
  public static final int LOG_BITS_IN_EXTENT = JavaSizeConstants.LOG_BITS_IN_BYTE + LOG_BYTES_IN_EXTENT;
  ...
  public static final int LOG_BITS_IN_OFFSET = JavaSizeConstants.LOG_BITS_IN_BYTE + LOG_BYTES_IN_OFFSET;
