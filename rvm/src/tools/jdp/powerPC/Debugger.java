...
class Debugger implements jdpConstants {
                  ...
                  JDPCommandInterface console, boolean _viewBoot, boolean _dejavu)
  {
    ...
    // currently, this is 4 instructions further from the .bootThread routine
  ...
  public void init(String args[])
  {
    ...
    // Create the AIX process, wait for it to start up and return
  ...
  private void goToMainMethod()
  {
    ...
    // Continue
    // We may get spurrious Trace/BPT trap as the system 
  ...
  public void doListThread(String command, String[] args) {
	...
	// threads loaded in the AIX system threads
