 ...
 *   (2) total compilation time in nanoseconds as computed by calls to VM_Time.now()
 *       This is accumulated as a double to avoid rounding errors. 
 *   (3) total number of bytes of bytecodes compiled by the compiler
 ...
 *   (4) total number of machine code insructions generated by the compiler
