...
public final class VM_OptMethodSummary implements VM_BytecodeConstants {
   ...
   */
  public static final int inlinedSizeEstimate(VM_NormalMethod method) {
   ...
   */
  public static final boolean hasMagic(VM_NormalMethod method) {
   ...
   */
  public static final boolean hasSynch(VM_NormalMethod method) {
   ...
   */
  public static final boolean hasArrayOp(VM_NormalMethod method) {
   ...
   */
  public static final boolean hasAllocation(VM_NormalMethod method) {
   ...
   */
  public static final boolean hasThrow(VM_NormalMethod method) {
   ...
   */
  public static final boolean hasInvoke(VM_NormalMethod method) {
    return hasInvoke(getSummary(method));
  }

  // returns true if the method contains getfield/putfield/getstatic/putstatic
  public static final boolean hasFieldOp(VM_NormalMethod method) {
   ...
   */
  public static final boolean mayWrite(VM_NormalMethod method, VM_Field field) {
   ...
   */
  public static void summarizeMethod(VM_NormalMethod method, byte[] bytecodes, 
   ...
   */
  private static void storeSummary(VM_NormalMethod method, int summary) {
   ...
   */
  private static void storeWriteSummary(VM_NormalMethod method, VM_FieldReference[] set) {
    int idx = method.getId();
   ...
   */
  private static int getSummary(VM_NormalMethod method) {
    int idx = method.getId();
   ...
   */
  private static VM_FieldReference[] getWriteSummary(VM_NormalMethod method) {
    int idx = method.getId();
    if (VM.VerifyAssertions) {
      VM._assert(method.getBytecodeLength() != 0);
      VM._assert(isValid(summaries[idx]));
   ...
   * 
   * @param method the VM_NormalMethod to be summarized
   * @param bytecodes the bytecode array to be summarized
   * @param isSynchronized does the VM_NormalMethod represent a synchronized method?
   * @return an int encoding the summary
   */
  private static void computeSummary(VM_NormalMethod method, byte[] bytecodes, 
				     boolean isSynchronized) {
    int calleeSize = 0;
    int bcIndex = 0;
