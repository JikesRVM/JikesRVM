...
public class OPT_Entrypoints
  ...
  static void init () {
    ...
    optLockMethod = (VM_Method)VM.getMember("LVM_Lock;", "inlineLock", 
        "(Ljava/lang/Object;)V");
    optUnlockMethod = (VM_Method)VM.getMember("LVM_Lock;", "inlineUnlock", 
        "(Ljava/lang/Object;)V");
    unlockAndThrow = (VM_Method)VM.getMember("LVM_Runtime;", "unlockAndThrow", 
        "(Ljava/lang/Object;Ljava/lang/Throwable;)V");
    //-#if RVM_WITH_CONCURRENT_GC
    RCGC_aastoreMethod = (VM_Method)VM.getMember("LVM_OptRCWriteBarrier;", 
        "aastore", "(Ljava/lang/Object;ILjava/lang/Object;)V");
    RCGC_resolvedPutfieldMethod = (VM_Method)VM.getMember(
        "LVM_OptRCWriteBarrier;", 
        "resolvedPutfield", "(Ljava/lang/Object;ILjava/lang/Object;)V");
    RCGC_unresolvedPutfieldMethod = (VM_Method)VM.getMember(
        "LVM_OptRCWriteBarrier;", 
        "unresolvedPutfield", "(Ljava/lang/Object;ILjava/lang/Object;)V");
    RCGC_resolvedPutstaticMethod = (VM_Method)VM.getMember(
        "LVM_OptRCWriteBarrier;", 
        "resolvedPutstatic", "(ILjava/lang/Object;)V");
    RCGC_unresolvedPutstaticMethod = (VM_Method)VM.getMember(
        "LVM_OptRCWriteBarrier;", 
    ...
    specializedMethodsField = (VM_Field)VM.getMember(
        "LOPT_SpecializedMethodPool;", 
        "specializedMethods", INSTRUCTION_ARRAY_ARRAY_SIGNATURE);
    specializedMethodsOffset = VM.getMember("LOPT_SpecializedMethodPool;", 
        "specializedMethods", INSTRUCTION_ARRAY_ARRAY_SIGNATURE).getOffset();
