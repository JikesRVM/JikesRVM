...
import com.ibm.JikesRVM.memoryManagers.watson.AddressSet;
import com.ibm.JikesRVM.memoryManagers.watson.AddressPairSet;
import com.ibm.JikesRVM.memoryManagers.watson.AddressTripleSet;
...
public class VM_CollectorThread extends VM_Thread
  ...
  public final void setGCOrdinal(int x) throws VM_PragmaUninterruptible {
    gcOrdinal = x;
  }
  ...
  // Note: "stack" must be in pinned memory: currently done by allocating it in the boot image.
  //
  public static VM_CollectorThread 
  ...
  public boolean           isActive;      // are we an "active participant" in gc?
  ...
  public int timeInRendezvous;       // time waiting in rendezvous (milliseconds)
  
  public double stoppingTime;        // mutator stopping time - until enter Rendezvous 1
  public double startingTime;        // time leaving Rendezvous 1
  public double rendezvousWaitTime;  // accumulated wait time in GC Rendezvous's
