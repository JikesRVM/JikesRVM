...
public class ScanStack implements VM_Constants, VM_GCConstants {
  ...
  // Three flags for controlling diagnostic output, in decreasing order of verbosity.
  // Setting an earlier flag will force a later flag on so the output is sensible.
