...
/**
 * A pragma that has the same direct effect as VM_PragmaUninterruptible
 ...
 * @author Dave Grove
 */
public class VM_PragmaUninterruptibleNoWarn extends VM_PragmaException {
  private static final VM_TypeReference me = getTypeRef("Lcom/ibm/JikesRVM/VM_PragmaUninterruptibleNoWarn;");
