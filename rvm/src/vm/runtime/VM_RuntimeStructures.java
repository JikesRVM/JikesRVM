...
public class VM_RuntimeStructures implements VM_Constants {
   ...
   */ 
  static int[] newStack(int n) throws VM_PragmaInline {
   ...
   */ 
  static int[] newContiguousIntArray(int n) throws VM_PragmaInline {
   ...
   */ 
  static VM_CompiledMethod[] newContiguousCompiledMethodArray(int n) throws
    VM_PragmaInline {
   ...
   * @return The contiguous object array
   */ 
  static VM_DynamicLibrary[] newContiguousDynamicLibraryArray(int n) throws VM_PragmaInline {
  ...
  static Object[] newTIB (int n) throws VM_PragmaInline {
