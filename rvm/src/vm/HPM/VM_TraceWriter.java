               ...
               VM_Callbacks.AppRunStartMonitor, VM_Callbacks.AppRunCompleteMonitor
{
  ...
  public void notifyExit(int value)
  {
	...
	VM.sysWriteln(", missed ",hpm.missedRecords());
      ...
      if (VM_HardwarePerformanceMonitors.report == true) {
        if(VM_HardwarePerformanceMonitors.verbose>=1) 
          VM.sysWriteln("VM_TraceWriter.notifyExit(",value,") PID ",pid);
        VM_HardwarePerformanceMonitors.Report();
        //BEGIN HRM
        if (VM_HardwarePerformanceMonitors.verbose>=1) {
        ...
        //END HRM
        if(VM_HardwarePerformanceMonitors.verbose>=1) 
          VM.sysWrite("VM_TraceWriter.notifyExit(",value);VM.sysWrite(") PID ",pid," finished\n");
      }
    }
  }
