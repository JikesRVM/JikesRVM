...
abstract class VM_Member implements VM_Constants, VM_ClassLoaderConstants {
  ...
  // Descriptor for this field or method - something like "I" for a field or "(I)V" for a method.
  //
  ...
  // For a static field:      offset of field from start of jtoc
  // For a static method:     offset of code object reference from start of jtoc
  // For a non-static field:  offset of field from start of object
  // For a non-static method: offset of code object reference from start of tib
  // See also:  VM_Class.getLiteralOffset() to obtain offset of constant from start of jtoc
  //
  ...
  protected int      dictionaryId;
   ...
   // To guarantee uniqueness, only the VM_ClassLoader class may construct VM_Member instances.
   // All VM_Member creation should be performed by calling "VM_ClassLoader.findOrCreate" methods.
   //
  protected VM_Member() { }
  ...
  public final String toString() {
    return getDeclaringClass().getName() + "." + getName() + " " + getDescriptor();
  }
}
