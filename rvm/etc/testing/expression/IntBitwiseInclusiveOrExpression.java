 ...
 */
public final class IntBitwiseInclusiveOrExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntBitwiseInclusiveOrExpression(final IntExpression a, final IntExpression b) {
		super(a, b, Type.INT, "|", Precedence.BITWISE_INCLUSIVE_OR);
		this.a = a;
		this.b = b;
	}
