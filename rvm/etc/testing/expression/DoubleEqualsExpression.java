 ...
 */
public final class DoubleEqualsExpression extends BinaryExpression implements BooleanExpression {

	private final DoubleExpression a;
	private final DoubleExpression b;
	
	
	public DoubleEqualsExpression(final DoubleExpression a, final DoubleExpression b) {
