 ...
 */
public final class DoubleMultiplicationExpression extends BinaryExpression implements DoubleExpression {

	private final DoubleExpression a;
	private final DoubleExpression b;
	
	
	public DoubleMultiplicationExpression(final DoubleExpression a, final DoubleExpression b) {
		super(a, b, Type.DOUBLE, "*", Precedence.MULTIPLICATIVE);
		this.a = a;
		this.b = b;
	}
