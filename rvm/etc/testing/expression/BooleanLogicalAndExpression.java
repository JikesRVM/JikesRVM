 ...
 */
public final class BooleanLogicalAndExpression extends BinaryExpression implements BooleanExpression {

	private final BooleanExpression a;
	private final BooleanExpression b;
	
	
	public BooleanLogicalAndExpression(final BooleanExpression a, final BooleanExpression b) {
		super(a, b, Type.BOOLEAN, "&&", Precedence.LOGICAL_AND);
		this.a = a;
		this.b = b;
	}
