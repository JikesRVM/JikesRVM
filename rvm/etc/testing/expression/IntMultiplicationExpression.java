 ...
 */
public final class IntMultiplicationExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntMultiplicationExpression(final IntExpression a, final IntExpression b) {
		super(a, b, Type.INT, "*", Precedence.MULTIPLICATIVE);
		this.a = a;
		this.b = b;
	}
