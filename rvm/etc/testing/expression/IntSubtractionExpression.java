 ...
 */
public final class IntSubtractionExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntSubtractionExpression(final IntExpression a, final IntExpression b) {
		super(a, b, Type.INT, "-", Precedence.ADDITIVE);
		this.a = a;
		this.b = b;
	}
