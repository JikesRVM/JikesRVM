 ...
 */
public final class IntBitwiseAndExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntBitwiseAndExpression(final IntExpression a, final IntExpression b) {
		super(a, b, Type.INT, "&", Precedence.BITWISE_AND);
		this.a = a;
		this.b = b;
	}
