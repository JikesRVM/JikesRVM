 ...
 */
public final class IntEqualsExpression extends BinaryExpression implements BooleanExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntEqualsExpression(final IntExpression a, final IntExpression b) {
