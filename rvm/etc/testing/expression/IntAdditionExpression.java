 ...
 */
public final class IntAdditionExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntAdditionExpression(final IntExpression a, final IntExpression b) {
