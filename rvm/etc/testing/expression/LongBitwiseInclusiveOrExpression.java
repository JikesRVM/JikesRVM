 ...
 */
public final class LongBitwiseInclusiveOrExpression extends BinaryExpression implements LongExpression {

	private final LongExpression a;
	private final LongExpression b;
	
	
	public LongBitwiseInclusiveOrExpression(final LongExpression a, final LongExpression b) {
		super(a, b, Type.LONG, "|", Precedence.BITWISE_INCLUSIVE_OR);
		this.a = a;
		this.b = b;
	}
