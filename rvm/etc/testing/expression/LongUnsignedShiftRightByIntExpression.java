 ...
 */
public final class LongUnsignedShiftRightByIntExpression extends BinaryExpression implements LongExpression {

	private final LongExpression a;
	private final IntExpression b;
	
	
	public LongUnsignedShiftRightByIntExpression(final LongExpression a, final IntExpression b) {
