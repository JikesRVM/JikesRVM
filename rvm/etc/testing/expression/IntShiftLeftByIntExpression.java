 ...
 */
public final class IntShiftLeftByIntExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntShiftLeftByIntExpression(final IntExpression a, final IntExpression b) {
