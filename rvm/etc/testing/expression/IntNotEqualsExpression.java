 ...
 */
public final class IntNotEqualsExpression extends BinaryExpression implements BooleanExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntNotEqualsExpression(final IntExpression a, final IntExpression b) {
