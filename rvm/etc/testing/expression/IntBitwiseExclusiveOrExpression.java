 ...
 */
public final class IntBitwiseExclusiveOrExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntBitwiseExclusiveOrExpression(final IntExpression a, final IntExpression b) {
		super(a, b, Type.INT, "^", Precedence.BITWISE_EXCLUSIVE_OR);
		this.a = a;
		this.b = b;
	}
