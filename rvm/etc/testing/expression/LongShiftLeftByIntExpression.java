 ...
 */
public final class LongShiftLeftByIntExpression extends BinaryExpression implements LongExpression {

	private final LongExpression a;
	private final IntExpression b;
	
	
	public LongShiftLeftByIntExpression(final LongExpression a, final IntExpression b) {
