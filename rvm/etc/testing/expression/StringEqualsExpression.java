 ...
 */
public final class StringEqualsExpression extends BinaryExpression implements BooleanExpression {
	
	private final StringExpression a;
	private final StringExpression b;
	
	
	public StringEqualsExpression(final StringExpression a, final StringExpression b) {
