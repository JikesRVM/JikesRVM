 ...
 */
public final class LongBitwiseExclusiveOrExpression extends BinaryExpression implements LongExpression {

	private final LongExpression a;
	private final LongExpression b;
	
	
	public LongBitwiseExclusiveOrExpression(final LongExpression a, final LongExpression b) {
		super(a, b, Type.LONG, "^", Precedence.BITWISE_EXCLUSIVE_OR);
		this.a = a;
		this.b = b;
	}
