 ...
 */
public final class IntLessEqualExpression extends BinaryExpression implements BooleanExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntLessEqualExpression(final IntExpression a, final IntExpression b) {
