 ...
 */
public final class IntLessThanExpression extends BinaryExpression implements BooleanExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntLessThanExpression(final IntExpression a, final IntExpression b) {
