 ...
 */
public final class LongBitwiseAndExpression extends BinaryExpression implements LongExpression {

	private final LongExpression a;
	private final LongExpression b;
	
	
	public LongBitwiseAndExpression(final LongExpression a, final LongExpression b) {
		super(a, b, Type.LONG, "&", Precedence.BITWISE_AND);
		this.a = a;
		this.b = b;
	}
