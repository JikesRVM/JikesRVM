 ...
 */
public final class IntGreaterEqualExpression extends BinaryExpression implements BooleanExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntGreaterEqualExpression(final IntExpression a, final IntExpression b) {
