 ...
 */
public final class IntModuloExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntModuloExpression(final IntExpression a, final IntExpression b) {
