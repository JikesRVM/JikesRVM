 ...
 */
public final class IntShiftRightByIntExpression extends BinaryExpression implements IntExpression {

	private final IntExpression a;
	private final IntExpression b;
	
	
	public IntShiftRightByIntExpression(final IntExpression a, final IntExpression b) {
