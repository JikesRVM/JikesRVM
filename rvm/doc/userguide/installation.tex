...
\xlink{{\tt \LinuxJdkURL}} {\LinuxJdkURL}.
...
file.  You can also acquire this via CVS from the
\xlink{public repository}{\RVMCVSURL}.
\item the RVM standard libraries.  This is a file {\tt rvmrt.jar}
available from the download page..  Due to license constraints,
this file is not available via CVS.
\end{itemize}
...
{\tt \$HOME/rvmRoot}.
\remark{TODO: update this with correct filenames, download instructions}.
\begin{verbatim}
% cd $HOME
% mkdir rvmRoot
% cd rvmRoot
% zcat jikesrvm.tar.gz | tar xvf - 
\end{verbatim}
...
\begin{verbatim}
% cd $HOME/rvmRoot
% zcat rvmSupport.tar.gz | tar xvf - 
\end{verbatim}
...
\item {\tt JIKES} the Jikes\trademark\ executable.
...
You will find that all current versions of 
