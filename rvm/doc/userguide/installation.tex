...
{\tt classpath-0.06.tgz}.  Create a directory named something like
{\tt \$RVM\_ROOT/classpath-0.06-build}.  
A command like {\tt /usr/gnu/tar -C
\$\{RVM\_ROOT\}/classpath-0.06-build xzf classpath-0.06.tgz} will
create the directory {\tt
\$\{RVM\_ROOT\}/classpath-0.06-build/classpath-0.06}.  You should
rename {\tt \$\{RVM\_ROOT\}/classpath-0.06-build/classpath-0.06} to
{\tt \$\{RVM\_ROOT\}/classpath-0.06-build/classpath}.  Now set your
