...
\item Download and install the Jikes compiler, if you have not already
...
\item Setup your evironment with definitions required by Jikes RVM.
...
use some other configuration if you prefer.
