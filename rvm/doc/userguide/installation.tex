...
Linux 8.2, install theRPMs {\tt Black\-downJa\-va2-JRE} and {\tt java2}. 
...
({\it e.g.}, build on Linux/x86 for an AIX\TMweb/PowerPC\TMweb
...
\hspace*{1cm}\texttt{August2003gccUpdater.dmg  Java141Developer.dmg jikes-1.18.tar.bz2 \\
\hspace*{1cm}CHUD\_3.0.1.dmg Dec2002DevToolsCD.dmg     dlcompat-20030629.tar.gz \\
}
