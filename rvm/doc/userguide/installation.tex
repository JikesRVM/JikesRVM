...
\multicolumn{3}{|c|}{\texonly{\hrulefill}
         No Special Requirements Known \texonly{\hrulefill}
} \\
\hline\hline 
\end{tabular}
...
You {\bf must rename} {\tt \$\{RVM\_ROOT\}/{\it
    class\-path-0.06-build}/\-class\-path-0.06} to {\tt \$\{RVM\_\-ROOT\}/{\it
    class\-path-0.06-build}/\-class\-path}.  Now set your {\tt
  CLASS\-PATH\_ROOT} to {\tt \$\{RVM\_\-ROOT\}/\-{\it class\-path-0.06-build}}
({\bf not} to {\tt \$\{RVM\_\-ROOT\}/\-{\it
...
\item {\em various basic Unix\Rboth{} utilities} e.g., {\tt grep}, {\tt xargs}, etc.
...
After the {\tt jbuild} script has completed successfully \link{you should be able 
