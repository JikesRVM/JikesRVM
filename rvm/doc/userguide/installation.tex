...
Red Hat Linux for Intel IA32 (Intel x86) has emerged as the 
primary platform for Jikes RVM.  SuSE Linux is also in daily use
...
JVMs that are known to fail on Linux/IA32 include the \IBMRweb{}~1.3.1 and
...
\subsection{The Hard Way}
 ...
 For any platform that is not \SuSERweb{} \LinuxRweb{} 8.2 or newer, or \RedHatTMweb{} Linux 7.3 or newer for \IntelRweb{}
...
\JikesTMweb{} Compiler & 1.18+ or 1.13 & \xlink{\tt \jikesURLHyphenated}{\jikesURL}       \\
...
\hline \multicolumn{3}{|c|}{\em \AIXTMweb{}/\PowerPCTMweb{}}                     \\ \hline
...
\item We have also used the \SunRweb{} JDK 1.4.1 to build Jikes RVM.
...
To install and build \JikesTMweb{} RVM, two items are required
\begin{itemize}
