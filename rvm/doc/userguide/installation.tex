...
\item[\IndexTexttt{RVM\_WITHOUT\_PREEMPTIVE\_THREAD\_SWITCHING}]
  Switch between threads only at explicit yield and wait calls.
...
The \texttt{\RVMTarFile} file contains a PostScript\TMweb{} version of this userguide
in \texttt{\$RVM\_\-ROOT/rvm/doc}.  Additionally, the 
\xlink{developerWorks web page}{\RVMHomeURL} keeps an online version of
the userguide and Javadoc\TMweb{} API, corresponding to the latest HEAD of the CVS
repository.
