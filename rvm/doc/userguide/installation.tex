...
out before the next release.  If you have any difficulty, please read
\link{the manual section on configuring {\tt CLASSPATH\_ROOT}}[ (section~\Ref)]{manual-classpath-root}.
...
%\resizebox{\linewidth}{!}{%
%\begin{center}
\begin{tabular}{|l|l|p{.5\textwidth}|} \hline
...
\hline \multicolumn{3}{|c|}{\em If automatically Building GNU
...
\hline \multicolumn{3}{|c|}{\em Mac OS X}                     \\ \hline

\multicolumn{3}{|c|}{\texonly{\hrulefill}
         No Special Requirements Known \texonly{\hrulefill}} \\ \hline

\multicolumn{3}{|p{\textwidth}|}{
  \link*{Please also see \SectionName{OSX installation} below}[Please
         also see subsection~\Ref{}, page~\Pageref{}, below]{OSX-install}} \\
\hline\hline 
\end{tabular}
...
automatically.  (Please look at \link{the discussion of setting
up \texttt{CLASSPATH\_ROOT}}[ (Section~\Ref,
        page~\Pageref)]{manual-classpath-root} before you make your decision.)
...
\item[\texttt{RVM\_ROOT}]  \index{RVM\_ROOT} the directory that contains
  the extracted distribution

\item[\texttt{RVM\_BUILD}]\index{RVM\_BUILD}
the directory where you would like the build
process to generate an executable Jikes RVM configuration

\item[\texttt{RVM\_HOST\_CONFIG}]\index{RVM\_HOST\_CONFIG}
...
\item[\texttt{RVM\_TARGET\_CONFIG}]\index{RVM\_TARGET\_CONFIG} the
...
\item[\texttt{PATH}] your path should contain \texttt{\$RVM\_ROOT/rvm/bin} in
...
\item[\texttt{CLASSPATH\_ROOT}] the {\bf parent} directory of the GNU
...
You {\bf must rename} \texttt{\$\{RVM\_ROOT\}/{\it
  ...
  CLASS\-PATH\_ROOT} to \texttt{\$\{RVM\_\-ROOT\}/\-{\it class\-path-0.06-build}}
...
We would like to use GNU \texttt{autoconf} to automate this
...
box}{http://www-124.ibm.com/pipermail/jikesrvm-researchers/2003-October/002367.html}:
\begin{quote}
