...
implementation details for the \JikesTM{} RVM optimizing compiler.
...
specific architecture of interest, such as \PowerPCTM.
...
it.  It is a \JavaTM{} expression that evaluates to an integer.
