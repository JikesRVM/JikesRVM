...
The RVM stores command-line options to the optimizing compiler 
...
When the compiler determines that a call target is one of these
magic methods, it inlines appropriate HIR for the magic method 
into the caller method.

An RVM implementor must be {\em extremely careful} when writing
