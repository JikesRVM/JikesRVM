...
elements are laid out in ascending order.  The number of elements
...
\end{gif}
\caption{Layout of a scalar object and an array object in RVM.}
\label{fig:objects}
\end{figure}
...
array length at a fixed negative offset), while scalar objects grow
