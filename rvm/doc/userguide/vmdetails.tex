...
The JTOC
is depicted \link*{in this figure}[in figure~\Ref]{fig:jtoc}.  
...
\index{stack conventions: Linux/x86}
\index{register conventions: Linux/x86}
\index{calling conventions: Linux/x86}
...
\xlink{{\tt
\$RVM\_ROOT/\-rvm/\-src/\-vm/\-arch/\-in\-tel/\-VM\_\-Re\-gis\-terCon\-stants.java}}
...
\newcommand{\OSXCallingConventionsURL}{http://devel\-op\-er.ap\-ple.com/\-do\-cu\-men\-ta\-tion/\-De\-ve\-lo\-perTools/\-Con\-cep\-tu\-al/Mach\-O\-Run\-time/\-Mach\-O\-Run\-time.pdf}
The calling conventions we use for OS~X are the same as those listed
at \xlink{\texttt{\OSXCallingConventionsURL}}{\OSXCallingConventionsURL}.
They're fairly similar to the Linux PowerPC calling conventions.  One
major difference is how the two operating systems handle the case of
a long parameter when you only have a single parameter register left.
