...
\noindent{\bf Stackframe constants (from VM\_Constants)}
...
\noindent{\bf Register constants (from VM\_Constants)}
...
The \jp\ RVM currently supports callbacks for the following events.
\begin{itemize}
