...
class's \link{TIB}{TIB}.  Consequently the dispatch mechanism differs for static and virtual 
methods.
\end{Label}
...
compilation stubs}[ (Paragraph~\Ref on page~\Pageref)]{par:lazy} for
the virtual methods.  The slots in the \link{JTOC}{JTOC} are filled in with
