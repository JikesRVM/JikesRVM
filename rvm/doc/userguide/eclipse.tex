...
recent --- 7.3 or newer --- version of Red Hat\TMweb{} Linux\Rweb for Intel\Rweb IA32;
one of us has also had good results with SuSE\Rweb{} Linux 8.1 and 8.2.
...
Jikes RVM has yet to implement this protocol.  (\link{It's on our TODO
  list, though}[--- see section~\Ref]{JDWP}.)

\item Running Eclipse requires that you build Jikes RVM with
RVM\_\-FOR\_\-SIN\-GLE\_\-VIR\-TU\-AL\_\-PRO\-CES\-SOR equal to 0. \xlink{The
...
3583)]{http://www-124.ibm.com/developerworks/bugs/?func=detailbug\&bug\_id=3583\&group\_id=95}.

\item As of this writing (September 2, 2003), 
\xlink{Jikes RVM defect \#
  2046}{http://www-124.ibm.com/developerworks/bugs/?func=detailbug\&bug\_id=2046\&group\_id=95} is still outstanding:
...
\item Add two variables to your Jikes RVM configuration file:
 \begin{description}
  \cindex[ANT\_CMD]{\texttt{ANT\_CMD}}
 \item[\tt ANT\_CMD] is the full pathname of the executable Ant command
  \cindex[ECLIPSE\_INSTALL\_DIR]{\texttt{ECLIPSE\_INSTALL\_DIR}}
 \item[\tt ECLIPSE\_INSTALL\_DIR] is the root of your Eclipse install
 \end{description}
...
\cindex[rvmeclipse]{\texttt{rvmeclipse}}
