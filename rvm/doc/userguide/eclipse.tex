...
RVM\_FOR\_SINGLE\_VIRTUAL\_PROCESSOR equal to 0. \xlink{The
...
\item Add two variables to your Jikes RVM configuration file:
 \begin{description}
  \cindex[ANT\_CMD]{\tt ANT\_CMD}
 \item[\tt ANT\_CMD] is the full pathname of the executable Ant command
  \cindex[ECLIPSE\_INSTALL\_DIR]{\tt ECLIPSE\_INSTALL\_DIR}
...
\cindex[rvmeclipse]{\tt rvmeclipse}
