...
We used to suggest that folks consider the following Emacs
modifications.  We expect that they will be superseded by
the \texttt{jikes-rvm.el} Emacs LISP source file before the next
release of \jrvm{}:
