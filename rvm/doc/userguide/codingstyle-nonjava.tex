...
preprocessor is discussed later}[, in section~\Ref]{section:preprocessor}.
...
fail if any \(\mbox{{\it variable\-name\/}}_i\) is not already set.
...
GNUmakefile}, \link{just as discussed in the Sun\Rweb{} style guide}[
