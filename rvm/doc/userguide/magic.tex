...
VM\_Magic}\IndexttClass{VM\_Magic}.  The second is the magical classes {\tt VM\_Address}\IndexttClass{VM\_Address}, {\tt
VM\_Word}\IndexttClass{VM\_Word}, {\tt VM\_Offset}\IndexttClass{VM\_Offset}, and  {\tt VM\_Extent}\IndexttClass{VM\_Extent} used in
