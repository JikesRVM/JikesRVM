...
mechanisms to code {\em uninterruptible}.
...
\item{} Uninterruptible code cannot cause class loading and this must
...
care, but in a few cases is unavoidable to avoid spurious warning
messages. 
...
exception VM\_PragmaUninterruptible, then it is uninterruptible.
