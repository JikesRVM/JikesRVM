...
\JikesTM{} RVM provides callbacks for many runtime events of
...
\subsubsection{An Example: Modifying \SPECjvmR{}98 to Report the End of a
Run}\label{sssec:callback-example}
The \SPECjvmR{}98 benchmark suite is configured to run one or more benchmarks
