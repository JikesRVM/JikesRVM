...
\end{itemize}
The relative performance and of these collectors is highly dependent on
the application. 

Currently, some of these collectors are more stable than others. 
The \texttt{SemiSpace} collector is the most stable and heavily tested
GC and is what we currently recommend for general usage. GC
researchers will of course want to experiment with other GC choices.
