...
\xlink{load-balancing parallel dequeues}{\SharedDequeueURL},
...
\item \xlink{Load-balancing shared parallel
    dequeues}{\SharedDequeueURL}, which provide load balancing double
  headed queue management for \xlink{address
    dequeues}{\AddressDequeueURL} (used by the GC work queue), and
