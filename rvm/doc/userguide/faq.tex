...
the first self-bootstrapped virtual machine written entirely in
...
No, there are already several JVMs in wide circulation that pass
...
escape analysis.  See the {\tt OPT\_SimpleEscape.java} file.
