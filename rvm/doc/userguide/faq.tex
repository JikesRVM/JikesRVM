...
\xlink{Use the {\tt jikesrvm-researchers} mailing list}[, available at {\tt \RVMResearcherMailingListURL}]{\RVMResearcherMailingListURL}.
...
\begin{description}
\item[\xlink{\texttt{jikesrvm-researchers}}{\RVMResearcherMailingListURL}]
...
(RVM\_\-FOR\_\-SIN\-GLE\_\-VIR\-TU\-AL\_\-PRO\-CES\-SOR equals 0), the virtual machine
multiplexes $m$ Java {\tt Thread}s
onto $n$ virtual processors (operating system pthreads).
In $m$-to-$1$ threading (RVM\_\-FOR\_\-SIN\-GLE\_\-VIR\-TU\-AL\_\-PRO\-CES\-SOR equals 1),
...
built with RVM\_\-FOR\_\-SIN\-GLE\_\-VIR\-TU\-AL\_\-PRO\-CES\-SOR equal to 0.
...
preferred values for RVM\_\-FOR\_\-SIN\-GLE\_\-VIR\-TU\-AL\_\-PRO\-CES\-SOR are as
follows: 
...
See the discussion in \link{the JNI section of the userguide}[
