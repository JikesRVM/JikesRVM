...
to compile the RVM source on both \LinuxR and
\AIXTM. Previously we were using version 1.13. Version 1.14
...
work exactly the same as in the \SunR{} class library.
...
%\index[SPECjvm98]{\SPECjvmR{}98}
%\index[SPECjbb2000]{\SPECjbbR{}2000}
\index{SPECjvm98}
\index{SPECjbb98}
