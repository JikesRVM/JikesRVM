...
The jdp debugger has been deprecated.
...
No, Jikes RVM does not currently support the Java\trademark 2 security
model.
...
As of Jikes RVM v2.1.0, the RVM relies on the open-source
\xlink{jazzlib}{\jazzlibURL}. 
implementation of java.util.zip and java.util.jar.  These implementations
are provided as part of the \xlink{GNU Classpath}{\classpathURL} project.
...
There is effort underway outside of IBM to get the 
\xlink{Classpath}{\classpathURL} libraries
to work with Jikes RVM.   Check the mailing lists for the latest
information on this topic.  Jikes RVM already uses the jazzlib jar file.
