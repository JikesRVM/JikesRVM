...
problem. For versions of Jikes RVM before 2.2.0, you must use jikes 1.13.
...
As of Jikes RVM v2.1.0, we use the \xlink{GNU Classpath}{\classpathURL} 
...
As of version 2.2.0 we mostly do. We plan to switch completely to the
GNU Classpath libraries in the near future. See
section~\ref{section:libraries} for more details. 
