...
execute a subset of the Java\trademark Virtual Machine specification.
It provides a 
...
We have not worked out a formal process yet, but expect to follow the
model of other successful open-source projects.  For now, if you'd like to
contribute, let us know and we'll take it from there.
...
Not yet.  The \xlink{DejaVu}{\DejavuURL} team hopes to release some code shortly.
