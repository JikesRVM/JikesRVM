This section provides an overview of Jikes RVM as well as
information for how best to use this document.

\subsection{Welcome to Jikes RVM}

\JikesTM\ RVM is a Research Virtual Machine 
 developed at the 
\xlink{\IBMR}{\IBMURL} 
...
This document provides \JikesTMweb{} RVM information that is not
...
This document is available as both \PostScriptR{} and HTML.  You will find the
...
The RVM web page includes \JavadocTM{} API 
