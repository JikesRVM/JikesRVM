...
For example, the PowerPC 604e only has four counters where the PowerPC 630 and Power 4 has eight.
The PowerPC 604e reserves event number 2 on every counter to count the number of instructions 
completed whereas the PowerPC 630 reserves event umber 3.
