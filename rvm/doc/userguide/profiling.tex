...
the code using the 
\xlink{{\tt
OPT\_InstrumentedEventCounterArrayManager}}{\OPTInstrumentedEventCounterArrayManagerURL} 
interface.
...
counters using 
\xlink{{\tt VM\_CounterArray.java}}{\VMCounterArrayURL}.  
...
\xlink{{\tt
VM\_InstrumentedControlFlowEdgeCounterData}}{\VMInstrumentedControlFlowEdgeCounterDataURL}).  There is also a
very generic data object called 
\xlink{{\tt VM\_StringCounterData}}{\VMStringCounterDataURL} 
that
...
\xlink{{\tt
OPT\_InsertBasicBlockCounters.java}}{\OPTInsertBasicBlockCountersURL},
\xlink{{\tt
OPT\_InsertYieldpointCounters.java}}{\OPTInsertYieldpointCountersURL},
\xlink{{\tt
OPT\_InsertMethodInvocationCounters.java}}{\OPTInsertMethodInvocationCountersURL} 
