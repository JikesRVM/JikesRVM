...
Example usage: {\tt rvm \\
\indent -X:aos:primary\_strategy=optonly \\
\indent -X:aos:share:insert\_instruction\_counters\_opt=true \\
\indent -X:aos:irc:instrumentation\_sampling=true \\
\indent -X:aos:counter\_based\_sample\_interval=10 MyProgram } \\
