...
\newcommand{\JikesTMFootnote}{\T \texttrademark\footnote{{\bf Jikes} is a
...
\newcommand{\JavaTMFootnote}{\T {\texttrademark}\footnote{\small {\bf Java} and all Java-based trademarks and
