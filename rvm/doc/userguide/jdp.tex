This section provides information regarding {\tt jdp}, the \jp\
debugger.
\index{debugging}
\index{jdp}
...
\index{Remote Reflection}
  {\tt jdp}, the \jp\ Debugger Primitive, is a low-level symbolic debugger 
...
Reflection (see the related paper on the \jp\ 
...
\item Interrupting a hung RVM:  If the RVM is running under the debugger
  ...
  window and killing the Jalapeno process.  This will send a signal to the
  Jalapeno process and {\tt jdp} will catch the signal before it gets to
  the Jalapeno process.  Hitting control-c in the jdp window will kill 
  {\tt jdp} itself.
