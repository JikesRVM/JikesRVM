...
final class Lister {
  ...
  void RI (int i, String op, MachineRegister R0, long n) {

  }

  void RDI (int i, String op, MachineRegister R0, Offset d, long n) {

  }

  void RNI (int i, String op, MachineRegister R0, long n) {
  ...
  void RXDI (int i, String op, MachineRegister R0, MachineRegister X, short s, Offset d, long n) {

  }

  void RFDI (int i, String op, MachineRegister X, short s, Offset d, long n) {
