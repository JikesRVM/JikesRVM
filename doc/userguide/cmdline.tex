...
you must modify either \IndexTexttt{BooleanOptions.opt.dat} or 
\IndexTexttt{ValueOptions.opt.dat}.  You should describe your desired
...
The \IndexTexttt{BooleanOptions.opt.dat} file defines boolean options for
...
The \IndexTexttt{ValueOptions.opt.dat} file defines non-boolean options for
the optimizing compiler.  The file describes each command-line option 
