...
}{\SystemsJournalPaperURL}.  
For a historical overview of the project, see the
\xlink{IBM Systems Journal, April 2005 paper\T~\cite{jikesrvm-open-source-2005}}{\SystemsJournalPaperHistoryURL}.
For an introduction to the memory managers (MMTk), see the 
\xlink{2004 ICSE\T~\cite{mmtk-icse-04}}{\MMTKICSEPaperURL}
 and the
\xlink{2004 SIGMETRICS\T~\cite{mmtk-sigmetrics-04}}{\MMTKSIGMETRICSPaperURL}
 papers.
For an overview of the adaptive system, see the
\xlink{2000 OOPSLA\T~\cite{jalapeno-adaptive-00}}{\OOPSLAPaperURL}
and IBM Technical Report
\xlink{IBM TR Nov'04\begin{iftex}~\cite{adaptive-tr-04}\end{iftex}}{\IBMTRURL} 
papers, respectively.
