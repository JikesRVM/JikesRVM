...
\newcommand{\version}{2.4.6+SVN}
\newcommand{\classpathversion}{0.92-generics}
...
\newcommand{\jikesURL}{http://jikes.sourceforge.net}
...
\newcommand{\SystemsJournalPaperURL}{{\RVMPubsURL}\#The\_Jalape.C3.B1o\_Virtual\_Machine}
\newcommand{\SystemsJournalPaperHistoryURL}{{\RVMPubsURL}\#The\_Jikes\_Research\_Virtual\_Machine\_project:\_Building\_an\_open-source\_research\_community} 
\newcommand{\JavaGrandePaperURL}{{\RVMPubsURL}\#grande99}
\newcommand{\OOPSLAPaperURL}{{\RVMPubsURL}\#Adaptive\_Optimization\_in\_the\_Jalape.C3.B1o\_JVM}
\newcommand{\IBMTRURL}{http://www.research.ibm.com/people/h/hind/papers.html\#aos04}
\newcommand{\MMTKICSEPaperURL}{http://cs.anu.edu.au/\~{}Steve.Blackburn/pubs/abstracts\#mmtk-icse-2004}
\newcommand{\MMTKSIGMETRICSPaperURL}{http://cs.anu.edu.au/\~{}Steve.Blackburn/pubs/abstracts\#mmtk-sigmetrics-2004}
...
\W \renewcommand{\htmlpanelfield}[3][\link]{\HlxAppend{\HlxPanelFields}%
  {\xml*{td bgcolor="###99ccff" align="center"}%
    #1{#2}{#3}\xml*{/td}}}
\W \htmlpanelfield[\xlink]{Home}{http://jikesrvm.sourceforge.net" target="\_top}
\W \htmlpanelfield[\xlink]{Project}{http://sourceforge.net/projects/jikesrvm" target="\_top}
