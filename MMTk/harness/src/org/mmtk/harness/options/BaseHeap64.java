 ...
 */
public final class BaseHeap64 extends org.vmutil.options.PagesOption {
  /**
   * Create the option.
   */
  public BaseHeap64() {
    super(Harness.options, "Base Heap 64",
        "Base Heap Size in 64-bit mode (scaled for the current plan)",0);
  }
