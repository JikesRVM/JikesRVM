...
public class Barriers {
   ...
   * collection and needs to manipulate character arrays without causing a write
   * barrier operation.
   * 
   * @param dst
  ...
  public static void performWriteInBarrier(ObjectReference ref, Address slot,
      ObjectReference target, Offset offset, int locationMetadata, int mode) {
  }

  /**
   * Atomically write a reference field of an object or array and return the old
  ...
  public static ObjectReference performWriteInBarrierAtomic(
      ObjectReference ref, Address slot, ObjectReference target, Offset offset,
  ...
  /**
   * Gets an element of a byte array without invoking any read barrier or bounds
   * check.
   * 
   * @param src
   *          the source array
