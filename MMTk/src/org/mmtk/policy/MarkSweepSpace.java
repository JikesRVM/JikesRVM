 ...
 * @date $Date$
 */
public final class MarkSweepSpace extends Space implements Constants,
    Uninterruptible {
   ...
   */
  public MarkSweepSpace(String name, int pageBudget, Address start, Extent bytes) {
  ...
  public void prepare() {
    ...
    MarkSweepLocal.zeroLiveBits(start, ((FreeListPageResource) pr)
        .getHighWater());
    inMSCollection = true;
  }
   ...
   *          the object ref to the storage to be initialized
   */
  public final void postCopy(ObjectReference object) throws InlinePragma {
