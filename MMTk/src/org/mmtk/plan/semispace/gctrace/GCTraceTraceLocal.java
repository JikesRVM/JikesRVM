 ...
 * @date $Date$
 */
public final class GCTraceTraceLocal extends SSTraceLocal implements
    Uninterruptible {
   ...
   * policy applies (such as those needed for trace generation) and taking the
   * appropriate actions.
   * 
   * @param object
   *          The object reference to be traced. In certain cases, this should
  ...
  /**
   * Ensure that the referenced object will not move during a collection by
   * 'precopying' it at the beginning.
   * 
   * @param object
   *          The object to ensure will not move.
   */
   ...
   * @param object
   *          The object in question
   * @return True if <code>obj</code> is a reachable object; unreachable
   *         objects may still be live, however
   */
  public boolean isReachable(ObjectReference object) {
    if (GCTrace.finalDead)
      return false;
