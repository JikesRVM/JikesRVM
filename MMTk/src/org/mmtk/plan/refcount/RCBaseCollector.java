 ...
 * state for the <i>RCBase</i> plan, which is the parent class for reference
 * counting collectors.
 * <p>
 * 
 ...
 * behaviors, so most of the collection logic in RCBaseMutator should really be
 ...
 * @date $Date$
 */
public abstract class RCBaseCollector extends StopTheWorldCollector implements
    Uninterruptible {
}
