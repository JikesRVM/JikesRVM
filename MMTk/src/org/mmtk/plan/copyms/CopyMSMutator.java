 ...
 * <p>
 * 
 * Specifically, this class defines <i>CopyMS</i> mutator-time allocation into
 * the nursery and mature space (through pre-tenuring). Per-mutator thread
 * collection semantics are also defined (flushing and restoring per-mutator
 * allocator state).
 * 
 * @see CopyMS
 * @see CopyMSCollector
 ...
 * @date $Date$
 */
public class CopyMSMutator extends StopTheWorldMutator implements
    Uninterruptible {
  ...
  public Space getSpaceFromAllocator(Allocator a) {
    if (a == nursery)
      return CopyMS.nurserySpace;
    if (a == mature)
      return CopyMS.msSpace;
