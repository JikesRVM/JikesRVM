...
public abstract class PlanConstraints implements Uninterruptible {
  ...
  public boolean needsStaticWriteBarrier() {
    return false;
  }

  /** @return True if this Plan requires static read barriers. */
  public boolean needsStaticReadBarrier() {
    return false;
  }
  ...
  /**
   * @return True if this object forwards objects <i>after</i> determining
   *         global object liveness (e.g. many compacting collectors).
   */
  ...
  public boolean needsImmortalTypeInfo() {
    return false;
  }
}
