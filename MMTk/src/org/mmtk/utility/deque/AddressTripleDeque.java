...
/**
 * This supports <i>unsynchronized</i> enqueuing and dequeuing of address
 * triples
 * 
 ...
 * @date $Date$
 */
public class AddressTripleDeque extends LocalDeque implements Constants,
    Uninterruptible {
   ...
   * @param addr3
   *          the third address to be inserted into the address queue
   */
   ...
   * @param addr3
   *          the third address to be pushed onto the address queue
   */
  ...
  /**
   * Pop the first address in a triple from the address queue, return zero if
   * the queue is empty.
   * 
