...
/**
 * This supports <i>unsynchronized</i> pushing and popping of addresses. In
 * addition, this can sort the entries currently on the shared stack.
 * 
 * @author <a href="http://www-ali.cs.umass.edu/~hertz">Matthew Hertz</a>
 * @version $Revision$
 * @date $Date$
 */
public class SortTODAddressStack extends LocalDeque implements Constants,
    Uninterruptible {
   ...
   * 
   * @param queue
   *          The shared stack to which this stack will append its buffers (when
   ...
   * 
   * @return The next address in the address stack, or zero if the stack is
   *         empty
   */
