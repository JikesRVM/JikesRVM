...
/**
 * This supports <i>unsynchronized</i> enqueuing and dequeuing of object
 * references
 * 
 * $Id$
 * 
 ...
 * @date $Date$
 */
public class ObjectReferenceDeque extends LocalDeque implements Constants,
    Uninterruptible {
   ...
   * 
   * @param object
   *          the object to be inserted into the object queue
   */
  ...
  /**
   * Push an object onto the object queue, force this out of line ("OOL"), in
   * some circumstnaces it is too expensive to have the push inlined, so this
   * call is made.
   * 
   * @param object
   *          the object to be pushed onto the object queue
   ...
   * 
   * @return The next object in the object queue, or zero if the queue is empty
   */
