 ...
 * double-linking increases the space demands slightly, but makes it far more
 * efficient to dequeue buffers and, for example, enables sorting of its
 * contents.
 * 
...
class Deque implements Constants, Uninterruptible {
  ...
  protected static final Word BUFFER_MASK = Word.one().lsh(LOG_BUFFER_SIZE)
      .minus(Word.one());
