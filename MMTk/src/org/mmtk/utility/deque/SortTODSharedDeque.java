...
/**
 * This class specializes SortSharedQueue to sort objects according to their
 * time of death (TOD).
 * 
 ...
 * @date $Date$
 */
final public class SortTODSharedDeque extends SortSharedDeque implements
    Uninterruptible {
   ...
   * @param arity
   *          The arity of the data to be enqueued
   */
