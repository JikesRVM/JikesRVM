 ...
 * @date $Date$
 */
public class AddressDeque extends LocalDeque implements Constants,
    Uninterruptible {
   ...
   * 
   * @param addr
   *          the address to be inserted into the address queue
   */
  ...
  /**
   * Push an address onto the address queue, force this out of line ("OOL"), in
