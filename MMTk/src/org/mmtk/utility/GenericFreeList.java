 ...
 * 
 */
public final class GenericFreeList extends BaseGenericFreeList implements
  ...
  /**
   * Set the "free" flag for a lump of units (both the first and last units in
   * the lump are set.
   * 
   * @param unit
   *          The first unit in the lump
   * @param isFree
   *          True if the lump is to be marked as free
   */
   ...
   * 
   * @param unit
   *          The index of the first unit in the lump to be set
   * @param next
   *          The value to be set.
   */
  protected void setNext(int unit, int next) {
    ...
    int newValue = (next == HEAD) ? (oldValue | NEXT_MASK)
        : ((oldValue & ~NEXT_MASK) | next);
   ...
   * @param unit
   *          The index of the first unit in the current lump
   * @return The index of the first unit of the previous lump of units in the
   *         list
   */
   ...
   * @return The index of the first unit in the lump to the "left"/"above" the
   *         lump in question.
   */
