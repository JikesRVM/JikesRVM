...
public final class MMType implements Constants, Uninterruptible {
   ...
   * 
   * @param isDelegated
   *          True if scanning of this type is delegated to the VM
   * @param isReferenceArray
   *          True if the type is array of reference
   * @param isAcyclic
   *          True if the type is inherently acyclic
   * @param allocator
   *          The allocator through which instances of this type should be
   *          allocated by defaul.
   * @param offsets
   *          An array of integer offsets for the fields of this type (if any).
   */
  ...
  /**
   * Return a slot (location of an address) given an object address and a
   * reference number.
   * 
   * @param object
   *          The address of an object
   * @param reference
   *          The number of a field in a scalar or the index into an array
  ...
  /**
   * Return the number of references in an object. In the case of a scalar this
   * is the number of fields, in the case of an array, the number of elements in
   * the array.
   * 
   * @param object
