...
/**
 * A pointer enumeration class. This class is used by the reference counting
 * collector to do recursive decrement.
 * 
 * @author Ian Warrington
 * @version $Revision$
 * @date $date: $
 */
public class RCSanityEnumerator extends Enumerator implements Uninterruptible {
   ...
   * 
   * @param rc
   *          The plan instance with respect to which the enumeration will
   *          occur.
   */
