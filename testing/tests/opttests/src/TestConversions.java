...
class TestConversions {
  ...
  public static boolean run() {
    ...
    if (!testSuccess) {
      System.out.println();
      System.out.print("-- double_limits --");
      System.out.println(" failed. ***************");
      System.out.println();
      System.out.println();
    }
  ...
  static void f2d() {
    if (f2d(-2.6F) != -2.5999999046325684D) {
      System.out.println();
      System.out.print("want: -2.5999999046325684\n got: ");
  ...
  static void testFloatLimits(float lo, float hi) {
    ...
    if ((!Float.toString(lo).equals("-Infinity")) ||
      ...
      System.out.println();
      System.out.println("float:  " +       lo + " .. " +       hi);
      testSuccess = false;
    }
    ...
    if ((!Long.toString((long)lo).equals("-9223372036854775808")) ||
      ...
      System.out.println();
      System.out.println("long:   " + (long)lo + " .. " + (long)hi);
      testSuccess = false;
    }
    ...
    if ((!Integer.toString((int)lo).equals("-2147483648")) ||
      ...
      System.out.println();
      System.out.println("int:    " + (int)lo + " .. " + (int)hi);
      testSuccess = false;
    }
  }
  ...
  static void testDoubleLimits(double lo, double hi) {
    ...
    if ((!dbl1.toString().equals("-Infinity")) ||
      ...
      System.out.println();
      System.out.println("double: " +       lo + " .. " +       hi);
      testSuccess = false;
    }
