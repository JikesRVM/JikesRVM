...
//   }
  ...
  void loadLibrary0(String libname, ClassLoader cL, boolean check) throws SecurityException, UnsatisfiedLinkError {
    ...
    if (libFullName == null) {
      ...
      VM.sysWrite("allpaths is:");
      VM.sysWriteln(allPaths);
      VM.sysWrite("PathSeparator is:");
      VM.sysWriteln(pathSeparator);
	...
	VM.sysWrite("Load library fullname:");
	VM.sysWriteln(libFullName);
