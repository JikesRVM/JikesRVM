...
public final class System {
  ...
  static {
    ...
    err = makeStandardErrorStream();
    out = makeStandardOutputStream();
    in = makeStandardInputStream();
     
    //new String.ConsolePrintStream(new BufferedOutputStream(new FileOutputStream(
    //        FileDescriptor.err)));
  ...
  public static void loadLibrary(String libName) {
	...
	return RVMClass.getClassFromStackFrame(2).getClassForType();
    }
  /**
  ...
  public static String mapLibraryName(String userLibName) {
      VM.sysWrite("XXXXMaplibraryname:");
      VM.sysWriteln(userLibName);
